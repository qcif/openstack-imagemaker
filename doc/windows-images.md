...
`--help` option or read the [openstack-imagemaker
manual](https://github.com/qcif/openstack-imagemaker/blob/main/openstack-imagemaker.md)
...
virtual machine by booting off the disk image.
    ...
    $ ./openstack-imagemaker run image.qcow2
...
Upload the disk image, optionally giving it a name:
    ...
    [creator@host]$ ./openstack-imagemaker upload --windows --agent --name "My new image" image.qcow2
